...
const InfoCard = ({ url, name, price }) => {
  return (
    <div className="flex flex-col justify-evenly text-right rounded-2xl rounded-tl-lg m-4 p-4 font-serif bg-white ">
      ...
      <button className="bg-gradient-to-r from-purple-500 to-violet-500 text-white font-serif m-2 py-2 rounded sm:ease-in-out sm:delay-80 sm:hover:-translate-y-1 sm:hover:scale-110 sm:hover:bg-blend-hard-light sm:duration-300">
        add to cart
      </button>
    </div>
  );
