    ...
    <div className="sm:grid sm:grid-cols-3">
      <div>
        <p className="sm:col-span-1 p-12 m-8 text-center text-white text-md sm:mt-15 mt-4">
          <FontAwesomeIcon
            ...
            icon={faBox}
          />
          <p className="pt-4 text-xl font-bold font-serif">Free delivery</p>
          <p className="mt-6 font-serif text-justify">
      ...
      <div>
        <p className="sm:col-span-2 p-12 m-4 text-center text-white text-md mt-4">
          <FontAwesomeIcon
            ...
            icon={faMoneyBill}
          />
          <p className="pt-4 text-xl font-bold font-serif">
            {" "}
      ...
      <div>
        <p className="sm:col-span-3 p-12 m-8 text-center text-white text-md sm:mt-15 mt-4">
          ...
          <p className="text-md mt-6 font-serif text-justify">
