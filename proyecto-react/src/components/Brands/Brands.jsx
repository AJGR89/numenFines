...
const Brands = () => {
  return (
    <div className="flex flex-wrap h-60 w-4/5 bg-gradient-to-r from-purple-900 to-fuchsia-900 justify-evenly items-center devide-x border-solid border-fuchsia-300 border-4 rounded-xl mx-auto bg-gradient-to-l hover:bg-gradient-to-r from-rose-900 to-blue-500">
      <img
